...
$members = $db->prepare('SELECT * FROM members WHERE m.id ORDER BY created DESC LIMIT ?,5');
...
<?php foreach ($members as $member): ?>
    ...
    <p class="day"><a href="view.php?id=<?php print(htmlspecialchars($member['id'], ENT_QUOTES)); ?>">
    <?php print(htmlspecialchars($member['created'], ENT_QUOTES)); ?>
