...
<div id="wrap">
  ...
  <div id="content">
    ...
    <div style="text-align: right"><a href="./admin/login.php">管理する</a></div>
...
<?php foreach ($posts as $post): ?>
    <div class="msg">
    <img src="https://watasho-bucket.s3.ap-northeast-1.amazonaws.com/<?php print(htmlspecialchars($post['picture'], ENT_QUOTES)); ?>" width="48" height="48" alt="<?php print(htmlspecialchars($post['name'], ENT_QUOTES)); ?>" />
